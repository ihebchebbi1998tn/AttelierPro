...
try {
    ...
    // Get total count
    $count_sql = "SELECT COUNT(*) as total FROM productions_products_lucci $where_clause";
    $count_stmt = $conn->prepare($count_sql);
    $count_stmt->execute($params);
    $total = $count_stmt->fetch()['total'];

    // Get products
    $sql = "SELECT * FROM productions_products_lucci $where_clause ORDER BY created_at DESC";
    if ($limit) {
