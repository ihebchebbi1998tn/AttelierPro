...
try {
    ...
    $filename = 'surmesure_' . $commandeId . '_' . uniqid() . '_' . time() . '.' . $extension;
    ...
    // Save to database
    $insertQuery = "INSERT INTO production_surmesure_images (commande_id, image_path, commentaire) VALUES (?, ?, ?)";
    ...
    error_log("Sur mesure image upload error: " . $e->getMessage());
