...
const SalaryConfiguration = () => {
  ...
  const getConfigValue = (key: string): number => {
    const value = config.find(c => c.config_key === key)?.config_value || 0;
    return Number(value);
  };
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  type="number"
                  step="0.0001"
                  value={(Number(getConfigValue('cnss_rate')) * 100).toFixed(4)}
                  onChange={(e) => updateLocalConfig('cnss_rate', Number(parseFloat(e.target.value) / 100 || 0))}
                  className="flex-1"
                />
                <Button 
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  type="number"
                  step="0.01"
                  value={(Number(getConfigValue('css_rate')) * 100).toFixed(2)}
                  onChange={(e) => updateLocalConfig('css_rate', Number(parseFloat(e.target.value) / 100 || 0))}
                  className="flex-1"
                />
                <Button 
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  type="number"
                  step="1"
                  value={Number(getConfigValue('deduction_chef_famille'))}
                  onChange={(e) => updateLocalConfig('deduction_chef_famille', Number(parseFloat(e.target.value) || 0))}
                  className="flex-1"
                />
                <Button 
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  type="number"
                  step="1"
                  value={Number(getConfigValue('deduction_per_child'))}
                  onChange={(e) => updateLocalConfig('deduction_per_child', Number(parseFloat(e.target.value) || 0))}
                  className="flex-1"
                />
                <Button 
                ...
                <TableRow key={bracket.id}>
                  ...
                  <TableCell>
                    <Input
                      type="number"
                      step="0.001"
                      value={Number(bracket.min_amount)}
                      onChange={(e) => updateLocalBracket(bracket.id, 'min_amount', Number(parseFloat(e.target.value) || 0))}
                      className="w-32"
                    />
                  </TableCell>
                  <TableCell>
                    <Input
                      type="number"
                      step="0.001"
                      value={bracket.max_amount !== null ? Number(bracket.max_amount) : ''}
                      onChange={(e) => updateLocalBracket(bracket.id, 'max_amount', e.target.value ? Number(parseFloat(e.target.value)) : null)}
                  ...
                  <TableCell>
                    <Input
                      type="number"
                      step="0.01"
                      value={(Number(bracket.tax_rate) * 100).toFixed(2)}
                      onChange={(e) => updateLocalBracket(bracket.id, 'tax_rate', Number((parseFloat(e.target.value) || 0) / 100))}
                      className="w-24"
                    />
                  </TableCell>
                  <TableCell>
